...
class SimpleCNNModel(nn.Module):
    ...
    def __init__(self, img_size, num_classes):
        ...
        self.feature_extractor = nn.Sequential(
            nn.Conv2d(3, 32, 5, 1, 1),#Делает карту принаков. Размер тензора (32, 100, 100)
            nn.BatchNorm2d(32),
            ...
            nn.Conv2d(32, 64, 5, 1, 1), # здесь размер тензора становиться (64, 50, 50)
            nn.BatchNorm2d(64),
            nn.ReLU(),
...
for epoch in range(n_epoch):
    ...
    if test_f1 > best_f1:
        best_f1 = test_f1
        best_epoch = epoch
        torch.save(model.state_dict(), "models/best_model_3_channels5.pth")
